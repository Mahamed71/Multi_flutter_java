...
void main() => runApp(const MyApp(color: Colors.grey));

@pragma('vm:entry-point')
void topMain() => runApp(const MyApp(color: Colors.grey));

@pragma('vm:entry-point')
void bottomMain() => runApp(const MyApp(color: Colors.red));
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'KokoREko'),
    );
  }
}
